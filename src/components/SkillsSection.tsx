      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="p-8 rounded-3xl bg-card/80 backdrop-blur-sm shadow-soft glass-card hover-lift">
          ...
          <div className="mt-12 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-2">
              {["Trading & Investing", "Team Leadership", "Sales & Marketing", "Communication", "Event Management", "Smart Contracts", "KPIs", "Predictive Analytics"].map((skill) => (
                <span
                  key={skill}
                  className="px-4 py-2 rounded-full bg-background/80 backdrop-blur-sm border border-border text-sm font-body text-muted-foreground hover:border-accent hover:text-accent transition-colors holographic"
                >
                  {skill}
                </span>
              ))}
